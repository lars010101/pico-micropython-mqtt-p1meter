...
publish_config("meter_reactive_energy_out", "Meter reactive energy out", "energy", "kVArh", "total_increasing")
publish_config("meter_reactive_energy_in", "Meter reactive energy in", "energy", "kVArh", "total_increasing")
...
publish_config("reactive_power_out", "Reactive power out", "power", "kVAr", "measurement")
publish_config("reactive_power_in", "Reactive power in", "power", "kVAr", "measurement")
publish_config("active_power_L1_out", "Active power L1 out", "power", "kW", "measurement")
publish_config("active_power_L1_in", "Active power L1 in", "power", "kW", "measurement")
publish_config("active_power_L2_out", "Active power L2 out", "power", "kW", "measurement")
publish_config("active_power_L2_in", "Active power L2 in", "power", "kW", "measurement")
publish_config("active_power_L3_out", "Active power L3 out", "power", "kW", "measurement")
publish_config("active_power_L3_in", "Active power L3 in", "power", "kW", "measurement")
publish_config("reactive_power_L1_out", "Reactive power L1 out", "power", "kVAr", "measurement")
publish_config("reactive_power_L1_in", "Reactive power L1 in", "power", "kVAr", "measurement")
publish_config("reactive_power_L2_out", "Reactive power L2 out", "power", "kVAr", "measurement")
publish_config("reactive_power_L2_in", "Reactive power L2 in", "power", "kVAr", "measurement")
publish_config("reactive_power_L3_out", "Reactive power L3 out", "power", "kVAr", "measurement")
publish_config("reactive_power_L3_in", "Reactive power L3 in", "power", "kVAr", "measurement")
publish_config("voltage_L1", "Voltage L1", "voltage", "V", "measurement")
publish_config("voltage_L2", "Voltage L2", "voltage", "V", "measurement")
publish_config("voltage_L3", "Voltage L3", "voltage", "V", "measurement")
publish_config("current_L1", "Current L1", "current", "A", "measurement")
publish_config("current_L2", "Current L2", "current", "A", "measurement")
publish_config("current_L3", "Current L3", "current", "A", "measurement")
